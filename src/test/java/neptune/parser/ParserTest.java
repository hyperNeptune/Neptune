...
public class ParserTest {
  ...
  public void testParser() throws Exception {
    ...
    if (iterator.hasNext()) {
      ...
      Assert.assertEquals(statement.getType(), StatementType.CREATE_TABLE);
      ...
      Assert.assertEquals(createTbStatement.getColumns()[0].getType(), IntType.INSTANCE);
      assertEquals(createTbStatement.getColumns()[1].getName(), "col2");
      Assert.assertEquals(createTbStatement.getColumns()[1].getType(), DoubleType.INSTANCE);
      assertEquals(createTbStatement.getColumns()[2].getName(), "col3");
      Assert.assertEquals(
          createTbStatement.getColumns()[2].getType(), StringType.getVarCharType(10));
      assertEquals(createTbStatement.getColumns()[3].getName(), "col4");
      Assert.assertEquals(createTbStatement.getColumns()[3].getType(), FloatType.INSTANCE);
      assertEquals(createTbStatement.getColumns()[4].getName(), "col5");
      Assert.assertEquals(createTbStatement.getColumns()[4].getType(), LongType.INSTANCE);
    }
    ...
    if (iterator.hasNext()) {
      ...
      Assert.assertEquals(insertStatement.getTuple()[0].getValue(sh, 0).getValue(), 1);
      Assert.assertEquals(insertStatement.getTuple()[0].getValue(sh, 1).getValue(), 2.0);
      Assert.assertEquals(insertStatement.getTuple()[0].getValue(sh, 2).getValue(), "hello");
      Assert.assertEquals(insertStatement.getTuple()[0].getValue(sh, 3).getValue(), 3.0f);
      Assert.assertEquals(insertStatement.getTuple()[0].getValue(sh, 4).getValue(), 4L);
    }
    ...
    if (iterator.hasNext()) {
      ...
      Schema schema = insertStatement.getTable().getSchema();
      assertEquals(insertStatement.getTable().getTableName(), "testp");
      Assert.assertEquals(insertStatement.getTuple()[0].getValue(sh, 0).getValue(), 2);
      Assert.assertEquals(insertStatement.getTuple()[0].getValue(sh, 1).getValue(), 3.0);
      Assert.assertEquals(insertStatement.getTuple()[0].getValue(sh, 2).getValue(), "world");
      Assert.assertEquals(insertStatement.getTuple()[0].getValue(sh, 3).getValue(), 4.0f);
      Assert.assertEquals(insertStatement.getTuple()[0].getValue(sh, 4).getValue(), 5L);
    }
    ...
    if (iterator.hasNext()) {
      ...
      Assert.assertEquals(updateStatement.getUpdateValue().left, "col2");
      Assert.assertEquals(
          updateStatement.getUpdateValue().right.evaluation(null, null).getValue(), 4.0);
    }
  }
