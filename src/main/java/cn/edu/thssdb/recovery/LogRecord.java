...
public class LogRecord {
    ...
    public LogRecord(int txn_id, int prev_lsn, LogRecordType logRecordType, RID rid, Tuple old_tuple, Tuple new_tuple){
        this.txn_id = txn_id;
        this.prev_lsn = prev_lsn;
        this.logRecordType = logRecordType;
        this.update_rid = rid;
        ...
        // | HEADER=20 | tuple_rid=8 | tuple_size=4 | old_tuple_data=SIZE | tuple_size=4 | new_tuple_data=SIZE |
        this.size = 20 + 8 + 4 + old_tuple.getSize() + 4 + old_tuple.getSize();
    }

    // constructor for NEWPAGE type
    public LogRecord(int txn_id, int prev_lsn, LogRecordType logRecordType, int prev_page_id, int page_id) {
        this.txn_id = txn_id;
        this.prev_lsn = prev_lsn;
        this.logRecordType = logRecordType;
